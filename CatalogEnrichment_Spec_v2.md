...
| `Laptop for college under $800` | `search_products(max_price=800)` | 5+ laptops $499–$799                                       |
| `Wireless headphones under $50` | `search_products(max_price=50)`  | **JBL Tune ($29.95), Anker Q20+ ($49.99)**                 |
| `Stainless steel tumbler`       | `search_products`                | **YETI, Stanley, Owala, Corkcicle**                        |
| `Noise canceling headphones`    | `search_products`                | **Sony XM5, AirPods Pro, Anker Q20+**                      |
