...
RECOMMENDATION_SYSTEM_PROMPT = (
    ...
    "via the preamble. Name 2-3 specific pieces with their prices and a "
    "warm one-sentence tie-back to the shopper's known preferences.\n"
    "  - For forward-looking questions ('recommend', 'find', 'show me "
    "something for…'), call a tool and weight the results toward the "
    ...
    "- trending_products: Use when the shopper asks for bestsellers, "
...
ORCHESTRATOR_SYSTEM_PROMPT = (
    ...
    "- search: finding specific pieces by name or attribute, "
