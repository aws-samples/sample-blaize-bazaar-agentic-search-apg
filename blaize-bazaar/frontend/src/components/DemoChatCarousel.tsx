...
const DEMO_SLIDES: DemoSlide[] = [
  {
    ...
    aiAvatarLabel: 'Maître d\'',
    agentBadges: [
      { label: 'Style Advisor', bgColor: EDITORIAL_BADGE.bg, textColor: EDITORIAL_BADGE.fg },
    ],
    aiResponseText: 'Two pieces that earn a place in quiet mornings — the Stoneware Pour-Over Set for the coffee ritual, and the Beeswax Pillar Candle for the warmth.',
    productCards: [
      { name: 'Stoneware Pour-Over Set', price: '$165', rating: '4.9', image: IMG.tumbler },
      { name: 'Beeswax Pillar Candle', price: '$38', rating: '4.6', image: IMG.cardigan },
    ],
    minMode: 'agentic',
  },
  {
    ...
    aiResponseText: 'Two linen pieces sit under your ceiling — the Cotton-Linen Crew Tee at $68 and the Linen Table Runner at $85.',
    productCards: [
      { name: 'Cotton-Linen Crew Tee', price: '$68', rating: '4.5', image: IMG.wideLeg },
      { name: 'Linen Table Runner', price: '$85', rating: '4.7', image: IMG.strawTote },
    ],
    minMode: 'agentic',
  },
  {
    ...
    userMessage: 'Is the Italian Linen Camp Shirt still in stock?',
    aiAvatarIconKey: 'database',
    aiAvatarLabel: 'Stock Keeper',
    agentBadges: [
      { label: 'Stock Keeper', bgColor: EDITORIAL_BADGE.bg, textColor: EDITORIAL_BADGE.fg },
    ],
    aiResponseText: 'Yes — 50 units in Indigo at $228. It\'s been our most-pulled shirt this week. The floor_check tool confirmed live stock.',
    contextNote: 'Live stock · 50 units',
    minMode: 'agentic',
  },
  {
    id: 'customer-support',
    ...
    aiAvatarLabel: 'Experience Guide',
    agentBadges: [
      { label: 'Experience Guide', bgColor: EDITORIAL_BADGE.bg, textColor: EDITORIAL_BADGE.fg },
    ],
  ...
  },
  {
    ...
    userMessage: 'Which home pieces are running low — and what\'s the best value?',
    aiAvatarIconKey: 'target',
    aiAvatarLabel: 'Maître d\'',
    agentBadges: [
      { label: 'Stock Keeper', bgColor: EDITORIAL_BADGE.bg, textColor: EDITORIAL_BADGE.fg },
      { label: 'Value Analyst', bgColor: EDITORIAL_BADGE.bg, textColor: EDITORIAL_BADGE.fg },
      { label: 'Curator', bgColor: EDITORIAL_BADGE.bg, textColor: EDITORIAL_BADGE.fg },
    ],
    aiResponseText: 'The Stock Keeper found 3 home pieces under 5 units. The Value Analyst says the Terracotta Planter at $52 and Brass Incense Holder at $45 are the best value — both under $55.',
    contextNote: 'Routed to three specialists · 1.4s',
    minMode: 'agentic',
  },
  {
    ...
    userMessage: 'What about the Linen Overshirt — does it wrinkle when you travel?',
    aiAvatarIconKey: 'brain',
    aiAvatarLabel: 'Maître d\'',
    agentBadges: [
      { label: 'Style Advisor', bgColor: EDITORIAL_BADGE.bg, textColor: EDITORIAL_BADGE.fg },
    ],
    aiResponseText: 'From earlier — the Linen Overshirt in Sage at $195. It\'s garment-washed, so the wrinkles are the point. Rolls into a packing cube and comes out looking intentional.',
  ...
  },
  {
    ...
    userMessage: 'Restock the Linen Overshirt — a thousand units.',
