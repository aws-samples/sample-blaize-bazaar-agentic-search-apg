...
const DEMO_SLIDES: DemoSlide[] = [
  {
    ...
    aiResponseText: 'Two pieces that earn a place in quiet mornings — the Stoneware Pour-Over Set for the coffee, the Beeswax Pillar Candle for the chill.',
    productCards: [
      { name: 'Stoneware Pour-Over Set', price: '$165', rating: '4.9', image: IMG.tumbler },
      { name: 'Beeswax Pillar Candle', price: '$38', rating: '4.8', image: IMG.cardigan },
    ],
    minMode: 'agentic',
  },
  {
    ...
    productCards: [
      { name: 'Cotton-Linen Crew Tee', price: '$98', rating: '4.7', image: IMG.wideLeg },
      { name: 'Linen Table Runner', price: '$68', rating: '4.9', image: IMG.strawTote },
    ],
    minMode: 'agentic',
  },
  {
    ...
    userMessage: 'Is the Italian Linen Linen Overshirt still on the floor?',
  ...
  },
  {
    ...
    aiResponseText: 'Inventory shows the Terracotta Planter at 4 units and the Brass Incense Holder at 6. Pricing puts them at $52 and $45 — the Vest is the gentler entry.',
  ...
  },
  {
    ...
    aiResponseText: 'From earlier — the Italian Linen Linen Overshirt at $52. It\'s garment-washed, so the wrinkles are the point. Rolls into a packing cube and comes out looking intentional.',
  ...
  },
  {
    ...
    userMessage: 'Restock the Italian Linen Linen Overshirt — a thousand units.',
