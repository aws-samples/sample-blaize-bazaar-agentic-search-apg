...
def main():
  ...
  parser.add_argument('--server-name', default='blaize-mcp-server', help='The name of the server deployed by this function.')
  ...
  parser.add_argument('--handler', default='blaize_search_server.lambda_handler', help='Lambda handler function')
